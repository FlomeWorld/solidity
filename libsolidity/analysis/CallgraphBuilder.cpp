...
public:
	...
	virtual bool visit(ImportDirective const&) override { return true; }
	virtual bool visit(ContractDefinition const&) override { return true; }
	virtual bool visit(InheritanceSpecifier const&) override { return true; }
	virtual bool visit(StructDefinition const&) override { return true; }
	virtual bool visit(UsingForDirective const&) override { return true; }
	virtual bool visit(EnumDefinition const&) override { return true; }
	virtual bool visit(EnumValue const&) override { return true; }
	virtual bool visit(ParameterList const&) override { return true; }
	virtual bool visit(FunctionDefinition const&) override { return true; }
	virtual bool visit(VariableDeclaration const&) override { return true; }
	virtual bool visit(ModifierDefinition const&) override { return true; }
	virtual bool visit(ModifierInvocation const&) override { return true; }
	virtual bool visit(EventDefinition const&) override { return true; }
	virtual bool visit(TypeName const&) override { return true; }
	virtual bool visit(ElementaryTypeName const&) override { return true; }
	virtual bool visit(UserDefinedTypeName const&) override { return true; }
	virtual bool visit(FunctionTypeName const&) override { return true; }
	virtual bool visit(Mapping const&) override { return true; }
	virtual bool visit(ArrayTypeName const&) override { return true; }
	virtual bool visit(Block const&) override { return true; }
	virtual bool visit(PlaceholderStatement const&) override { return true; }
	virtual bool visit(IfStatement const&) override { return true; }
	virtual bool visit(WhileStatement const&) override { return true; }
	virtual bool visit(ForStatement const&) override { return true; }
	virtual bool visit(Continue const&) override { return true; }
	virtual bool visit(InlineAssembly const&) override { return true; }
	virtual bool visit(Break const&) override { return true; }
	virtual bool visit(Return const&) override { return true; }
	virtual bool visit(Throw const&) override { return true; }
	virtual bool visit(VariableDeclarationStatement const&) override { return true; }
	virtual bool visit(ExpressionStatement const&) override { return true; }
	virtual bool visit(Conditional const&) override { return true; }
	virtual bool visit(Assignment const&) override { return true; }
	virtual bool visit(TupleExpression const&) override { return true; }
	virtual bool visit(UnaryOperation const&) override { return true; }
	virtual bool visit(BinaryOperation const&) override { return true; }
	virtual bool visit(FunctionCall const&) override { return true; }
	virtual bool visit(NewExpression const&) override { return true; }
	virtual bool visit(MemberAccess const&) override { return true; }
	virtual bool visit(Identifier const&) override { return true; }
	virtual bool visit(ElementaryTypeNameExpression const&) override { return true; }

	virtual void endVisit(SourceUnit const&) override {}
	virtual void endVisit(PragmaDirective const&) override {}
	virtual void endVisit(ImportDirective const&) override {}
	virtual void endVisit(ContractDefinition const&) override {}
	virtual void endVisit(InheritanceSpecifier const&) override {}
	virtual void endVisit(UsingForDirective const&) override {}
	virtual void endVisit(StructDefinition const&) override {}
	virtual void endVisit(EnumDefinition const&) override {}
	virtual void endVisit(EnumValue const&) override {}
	virtual void endVisit(ParameterList const&) override {}
	virtual void endVisit(FunctionDefinition const&) override {}
	virtual void endVisit(VariableDeclaration const&) override {}
	virtual void endVisit(ModifierDefinition const&) override {}
	virtual void endVisit(ModifierInvocation const&) override {}
	virtual void endVisit(EventDefinition const&) override {}
	virtual void endVisit(TypeName const&) override {}
	virtual void endVisit(ElementaryTypeName const&) override {}
	virtual void endVisit(UserDefinedTypeName const&) override {}
	virtual void endVisit(FunctionTypeName const&) override {}
	virtual void endVisit(Mapping const&) override {}
	virtual void endVisit(ArrayTypeName const&) override {}
	virtual void endVisit(Block const&) override {}
	virtual void endVisit(PlaceholderStatement const&) override {}
	virtual void endVisit(IfStatement const&) override {}
	virtual void endVisit(WhileStatement const&) override {}
	virtual void endVisit(ForStatement const&) override {}
	virtual void endVisit(Continue const&) override {}
	virtual void endVisit(InlineAssembly const&) override {}
	virtual void endVisit(Break const&) override {}
...
void CallgraphBuilder::build(vector<shared_ptr<ASTNode>> const& _nodes)
{
